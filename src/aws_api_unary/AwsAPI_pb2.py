...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=b'\n\x0c\x41wsAPI.proto\x12\x06\x41wsAPI\"#\n\x11GetObjectsRequest\x12\x0e\n\x06\x62ucket\x18\x01 \x01(\t\"\x1c\n\x0bObjectReply\x12\r\n\x05\x63ount\x18\x01 \x01(\x03\x32\x44\n\x02S3\x12>\n\nGetObjects\x12\x19.AwsAPI.GetObjectsRequest\x1a\x13.AwsAPI.ObjectReply\"\x00\x62\x06proto3'
)
...
_OBJECTREPLY = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='count', full_name='AwsAPI.ObjectReply.count', index=0,
